...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if sync=='sync':
            email_list, mail_ids, phishing_email= email_features.receive_emails()
            print(mail_ids)
            print(phishing_email)
            print(type(phishing_email))
            print("mihihr")
            # phishing_email=phishing_email["is_spam"]

            if phishing_email=='false':
                phishing_email=("Emails are being checked and they are not spam Emails")

            else:
                phishing_email=("Emails are contating Spams")
            ...
            email_data = { 
                ...
                'phishing' : "Emails are being checked and they are not spam Emails",
...
def OpenAi(request):
    ...
    if request.method == 'POST':
        ...
        email_body = { 'title' : title, 'body' : body,  'user_email': sender_email, 'receiver_email' : receiver_email,  'message' : 'Auto Email Has been Generated'}
